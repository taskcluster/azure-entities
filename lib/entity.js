...
Entity.setup = function(options) {
  ...
  // Set table and client
  subClass.prototype.__client     = client;
  subClass.prototype.__table      = table;

  // Make some auxiliary methods bound to table and denodified
  var aux = {};
  [
    'createTable',
    'deleteTable',
    ...
    aux[method] = Promise.denodeify(client[method].bind(client, table));
  });
